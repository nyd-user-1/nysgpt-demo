        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="pt-0 pb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
              {/* All chart cards — sorted alphabetically */}
              {[
                { path: '/charts/budget', label: 'Budget', desc: 'NYS budget spending', color: 'hsl(160 60% 45%)', id: 'lBudget', type: 'area' as const,
                ...
                { path: '/charts/contracts', label: 'Contracts', desc: 'State contracts', color: 'hsl(32 95% 50%)', id: 'lContract', type: 'area' as const,
                ...
                { path: '/charts/lobbying', label: 'Lobbying', desc: 'Lobbyist compensation', color: 'hsl(217 91% 60%)', id: 'lLobby', type: 'area' as const,
                  data: [{x:0,y:6},{x:1,y:8},{x:2,y:10},{x:3,y:12},{x:4,y:14},{x:5,y:16},{x:6,y:18},{x:7,y:22},{x:8,y:24},{x:9,y:28}] },
                { path: '/charts/revenue', label: 'Revenue', desc: 'NYS revenue over time', color: 'hsl(160 60% 45%)', id: 'cRevenue', type: 'area' as const,
