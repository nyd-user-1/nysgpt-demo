        ...
        <div className="flex items-center justify-between px-4 py-1.5 bg-background flex-shrink-0">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <button
              ...
              className={cn("hidden md:inline-flex items-center justify-center h-9 w-9 rounded-md text-foreground hover:bg-muted transition-colors flex-shrink-0", leftSidebarOpen && "bg-muted")}
