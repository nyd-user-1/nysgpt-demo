                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <div className="relative sm:hidden">
                      ...
                      {mobileDrawerCategory && !mobilePlusMenuOpen && (
                        <div className="fixed left-3 right-3 bottom-[44px] max-h-[calc(100dvh-272px)] rounded-2xl border border-border/60 bg-background shadow-lg overflow-hidden z-[60] flex flex-col">
                          {/* Header */}
