            ...
            <div className="flex items-center justify-between px-4 py-3 bg-background flex-shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="md:hidden inline-flex items-center justify-center h-10 rounded-md px-3 text-foreground hover:bg-muted transition-colors font-semibold text-xl"
                >
                  NYSgpt
                </button>
              </div>
              ...
              <div className="rounded-2xl bg-[#fafafa] border-0 p-3 shadow-lg">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {/* Sample prompts selector (lightbulb) - now hidden, replaced by "+" menu */}
                    ...
                    {/* Filter Buttons - removed, replaced by "+" menu */}
                    {false && (
                    <>
